    ...
    <>
      ...
      {lightbox !== null && (
        <div className="gl-lightbox" onClick={closeLightbox}>
          ...
          {/* Close */}
          <button className="gl-lb-close" onClick={closeLightbox}>✕</button>
          ...
          {/* Prev */}
          <button className="gl-lb-nav gl-lb-nav--prev" onClick={prevImg}>
          ...
          <div className="gl-lb-img-wrap" onClick={e => e.stopPropagation()}>
            <img
              ...
              className="gl-lb-img"
            />
            <p className="gl-lb-caption">{IMAGES[lightbox].caption}</p>
          </div>

          {/* Next */}
          <button className="gl-lb-nav gl-lb-nav--next" onClick={nextImg}>
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
